...
CREATE TABLE Cars (
		   ...
		   ,PlateNumber NVARCHAR(50) CONSTRAINT UC_PlateNumber UNIQUE NOT NULL
		   ,Manufacturer NVARCHAR(50) NOT NULL
		   ,Model NVARCHAR(50) NOT NULL
		   ,CarYear INT NOT NULL
		   ,CategoryId INT CONSTRAINT FK_Categories FOREIGN KEY REFERENCES Categories(Id) NOT NULL
		   ,Doors INT NOT NULL
...
CREATE TABLE Customers (
			...
			,DriverLicenceNumber NVARCHAR(20) CONSTRAINT UC_DriverLicNumber UNIQUE NOT NULL
...
CREATE TABLE RentalOrders (
			...
			,CarID INT CONSTRAINT FK_RentalOrers_Cars FOREIGN KEY REFERENCES Cars(Id) NOT NULL
...
INSERT INTO Categories (CategoryName) VALUES
	       ...
	       ,('Roadster')
	       ,('SUV')
INSERT INTO Cars (PlateNumber,Manufacturer,Model,CarYear,CategoryId,Doors,Availiable) VALUES
